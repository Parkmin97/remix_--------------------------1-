...
export const CLASSICAL_PIECES: ClassicalPiece[] = [
  {
    ...
    bpm: 108,
    durationSeconds: 60,
    description: '운명의 문을 두드리는 전율과 압도적인 강렬함의 오케스트라 최고 명곡입니다. 4박자 강한 지휘로 박자를 맞추세요.',
    audioUrl: '/audio/beethoven5.mp3',
    fallbackAudioUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Symphony_No._5_1st_movement.mp3',
    notesSequence: generateNotesForPiece(108, '4/4', ['G4', 'G4', 'G4', 'Eb4', 'F4', 'F4', 'F4', 'D4', 'C4', 'E4', 'G4', 'C5'])
  },
  {
    id: 'piece-3-3',
  ...
  },
  {
    ...
    bpm: 116,
    durationSeconds: 60,
    description: '열정적이고 힘차게 몰아치는 오케스트라의 대표적인 강렬한 행진곡입니다. 위아래 2박자 강한 리듬으로 이끄세요.',
    audioUrl: '/audio/carmen.mp3',
    fallbackAudioUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c0/Bizet_-_Carmen_Overture.mp3',
    notesSequence: generateNotesForPiece(116, '2/4', ['A4', 'C5', 'E5', 'E5', 'D5', 'C5', 'B4', 'A4', 'G#4', 'A4'])
  },
  {
    id: 'piece-1-4',
    ...
    bpm: 132,
    durationSeconds: 60,
    description: '폭풍우처럼 강렬하고 빠르게 몰아치는 카리스마 현악 오케스트라입니다. 명확한 수직 강박으로 정밀 타격하세요.',
    audioUrl: '/audio/summer.mp3',
    fallbackAudioUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/3d/Vivaldi_Summer_mvt_3_Presto_-_John_Harrison_violin.mp3',
