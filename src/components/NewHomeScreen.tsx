  ...
  return (
    <div className="min-h-full flex flex-col justify-start max-w-2xl mx-auto w-full px-4 pt-6 pb-20 gap-5 text-white">
      ...
      <div className="text-center space-y-1.5 shrink-0">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 backdrop-blur-md shadow-md">
          <Shield className="w-5 h-5 text-amber-400" />
          <h1 className="text-xl sm:text-2xl font-serif font-bold text-white tracking-wide">
            디톡스 모드 선택
          </h1>
        </div>
        <p className="text-xs text-neutral-300 break-keep pt-1">
